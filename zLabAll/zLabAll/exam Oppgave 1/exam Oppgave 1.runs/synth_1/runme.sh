...
HD_PWD='C:/Users/tyloo/Desktop/Digitale systemer/zLabAll/exam Oppgave 1/exam Oppgave 1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Greater_Than.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Greater_Than.tcl
