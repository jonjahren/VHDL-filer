...
HD_PWD='C:/Users/jonja/Documents/zLabAll/zLabAll/bcd_counter/bcd_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bcd_7segment.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bcd_7segment.tcl
