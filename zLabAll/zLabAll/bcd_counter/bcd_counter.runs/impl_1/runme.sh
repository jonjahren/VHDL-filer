...
HD_PWD='C:/Users/jonja/Documents/zLabAll/zLabAll/bcd_counter/bcd_counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bcd_7segment.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bcd_7segment.tcl -notrace
