...
## Switches
#set_property -dict { PACKAGE_PIN A8    IOSTANDARD LVCMOS33 } [get_ports { seg_select1[0] }]; #IO_L12N_T1_MRCC_16 Sch=sw[0]
#set_property -dict { PACKAGE_PIN C11   IOSTANDARD LVCMOS33 } [get_ports { seg_select2[1] }]; #IO_L13P_T2_MRCC_16 Sch=sw[1]
#set_property -dict { PACKAGE_PIN C10   IOSTANDARD LVCMOS33 } [get_ports { seg_select3[2] }]; #IO_L13N_T2_MRCC_16 Sch=sw[2]
#set_property -dict { PACKAGE_PIN A10   IOSTANDARD LVCMOS33 } [get_ports { seg_select4[3] }]; #IO_L14P_T2_SRCC_16 Sch=sw[3]
...
## Buttons
#set_property -dict { PACKAGE_PIN D9    IOSTANDARD LVCMOS33 } [get_ports { i_switch1[0] }]; #IO_L6N_T0_VREF_16 Sch=btn[0]
#set_property -dict { PACKAGE_PIN C9    IOSTANDARD LVCMOS33 } [get_ports { i_switch2[1] }]; #IO_L11P_T1_SRCC_16 Sch=btn[1]
#set_property -dict { PACKAGE_PIN B9    IOSTANDARD LVCMOS33 } [get_ports { i_switch3[2] }]; #IO_L11N_T1_SRCC_16 Sch=btn[2]
#set_property -dict { PACKAGE_PIN B8    IOSTANDARD LVCMOS33 } [get_ports { i_enable[3] }]; #IO_L12P_T1_MRCC_16 Sch=btn[3]
...
#set_property IOSTANDARD LVCMOS33 [get_ports i_switch1]
#set_property IOSTANDARD LVCMOS33 [get_ports i_switch2]
#set_property IOSTANDARD LVCMOS33 [get_ports i_switch3]
#set_property IOSTANDARD LVCMOS33 [get_ports ja_led1]
#et_property IOSTANDARD LVCMOS33 [get_ports ja_led2]
#set_property IOSTANDARD LVCMOS33 [get_ports ja_led3]
#set_property IOSTANDARD LVCMOS33 [get_ports ja_led4]
#set_property IOSTANDARD LVCMOS33 [get_ports ja_led5]
#set_property IOSTANDARD LVCMOS33 [get_ports ja_led6]
#set_property IOSTANDARD LVCMOS33 [get_ports ja_led7]
...
#set_property IOSTANDARD LVCMOS33 [get_ports seg_select2]
#set_property IOSTANDARD LVCMOS33 [get_ports seg_select3]
#set_property IOSTANDARD LVCMOS33 [get_ports seg_select4]
set_property PACKAGE_PIN E3 [get_ports clk]

#set_property PACKAGE_PIN A8 [get_ports seg_select1]
#set_property PACKAGE_PIN C11 [get_ports seg_select2]
#set_property PACKAGE_PIN C10 [get_ports seg_select3]
#set_property PACKAGE_PIN A10 [get_ports seg_select4]
#set_property PACKAGE_PIN K16 [get_ports o_led]
#set_property PACKAGE_PIN A18 [get_ports ja_led7]
#set_property PACKAGE_PIN B18 [get_ports ja_led6]
#set_property PACKAGE_PIN D13 [get_ports ja_led5]
#set_property PACKAGE_PIN D12 [get_ports ja_led4]
#set_property PACKAGE_PIN A11 [get_ports ja_led3]
#set_property PACKAGE_PIN B11 [get_ports ja_led2]
#set_property PACKAGE_PIN G13 [get_ports ja_led1]
#set_property PACKAGE_PIN B8 [get_ports i_switch3]
#set_property PACKAGE_PIN B9 [get_ports i_switch2]
#set_property PACKAGE_PIN C9 [get_ports i_switch1]
#set_property PACKAGE_PIN D9 [get_ports i_enable]
