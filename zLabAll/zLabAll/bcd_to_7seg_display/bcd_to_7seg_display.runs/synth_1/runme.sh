...
HD_PWD='C:/Users/jonja/Documents/zLabAll/zLabAll/bcd_to_7seg_display/bcd_to_7seg_display.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log seven_segments.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source seven_segments.tcl
