...
set_property -dict {PACKAGE_PIN A5 IOSTANDARD LVCMOS33} [get_ports {CK_AN_N[0]}]
#set_property -dict { PACKAGE_PIN A0    IOSTANDARD LVCMOS33 } [get_ports { CK_AN_N[0] }]; #IO_L9N_T1_DQS_AD7N_35 Sch=ck_an_n[0]
set_property -dict {PACKAGE_PIN A1 IOSTANDARD LVCMOS33} [get_ports {CK_AN_N[1]}]
#set_property -dict { PACKAGE_PIN A2    IOSTANDARD LVCMOS33 } [get_ports { CK_AN_N[1] }]; #IO_L9N_T1_DQS_AD7N_35 Sch=ck_an_n[1]
set_property -dict {PACKAGE_PIN A3 IOSTANDARD LVCMOS33} [get_ports {CK_AN_N[2]}]
set_property -dict {PACKAGE_PIN A4 IOSTANDARD LVCMOS33} [get_ports {CK_AN_N[3]}]
...
set_property SLEW SLOW [get_ports {CK_AN_N[1]}]
