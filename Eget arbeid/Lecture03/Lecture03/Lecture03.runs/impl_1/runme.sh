...
HD_PWD='D:/Skole/Digitale systemer og programmering/VHDL programmering/Lecture03/Lecture03/Lecture03.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux_4.tcl -notrace
