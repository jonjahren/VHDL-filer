...
HD_PWD='D:/Skole/Digitale systemer og programmering/VHDL programmering/Lecture03/Lecture03/Lecture03.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux_4.tcl
