...
HD_PWD='D:/Skole/Digitale systemer og programmering/VHDL programmering/Lab 03/Lab_03_Bertil/Lab_03_Bertil.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab_03_Part_3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab_03_Part_3.tcl -notrace
