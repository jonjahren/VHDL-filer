...
HD_PWD='D:/Skole/Digitale systemer og programmering/VHDL programmering/Lab 03/Lab_03_Bertil/Lab_03_Bertil.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab_03_Part_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab_03_Part_3.tcl
