...
HD_PWD='D:/Skole/Digitale systemer og programmering/VHDL programmering/Lab 02/Lab_02_Part2/Lab_02_Part2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab_02_Part2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab_02_Part2.tcl -notrace
