...
HD_PWD='D:/Skole/Digitale systemer og programmering/VHDL programmering/Lab 02/Lab_02_Part2/Lab_02_Part2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab_02_Part2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab_02_Part2.tcl
