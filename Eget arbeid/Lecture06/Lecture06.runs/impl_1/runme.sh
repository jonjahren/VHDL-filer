...
HD_PWD='D:/Skole/Digitale systemer og programmering/VHDL programmering/Lecture06/Lecture06.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Mod_16_Test_Block_2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Mod_16_Test_Block_2.tcl -notrace
