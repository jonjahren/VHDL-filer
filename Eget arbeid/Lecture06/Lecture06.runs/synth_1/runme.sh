...
HD_PWD='D:/Skole/Digitale systemer og programmering/VHDL programmering/Lecture06/Lecture06.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mod_16_Test_Block_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mod_16_Test_Block_2.tcl
