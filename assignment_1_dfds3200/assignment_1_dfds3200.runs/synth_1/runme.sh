...
HD_PWD='C:/Users/jonja/Documents/assignment_1_dfds3200/assignment_1_dfds3200.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bs_cell.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bs_cell.tcl
