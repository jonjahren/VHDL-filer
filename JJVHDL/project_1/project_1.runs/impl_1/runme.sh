...
HD_PWD='C:/Users/jonja/Documents/VHDL/JJVHDL/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab01part2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab01part2.tcl -notrace
