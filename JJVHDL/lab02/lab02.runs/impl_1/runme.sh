...
HD_PWD='C:/Users/jonja/Documents/VHDL/JJVHDL/lab02/lab02.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log full_adder_vhdl_code.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source full_adder_vhdl_code.tcl -notrace
