...
HD_PWD='C:/Users/Vetle/OneDrive/Skrivebord/Lab03_Vivado/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log two_to_four_decoder_lab03.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source two_to_four_decoder_lab03.tcl -notrace
