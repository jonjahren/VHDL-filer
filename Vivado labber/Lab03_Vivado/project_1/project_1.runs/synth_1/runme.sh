...
HD_PWD='C:/Users/Vetle/OneDrive/Skrivebord/Lab03_Vivado/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log two_to_four_decoder_lab03.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source two_to_four_decoder_lab03.tcl
