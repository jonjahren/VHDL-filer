...
HD_PWD='C:/Users/Vetle/.vivado_hls/Lab01_Part2_VetleLund/Lab02_ Vetle_Lund/Lab02_ Vetle_Lund.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab02_part1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab02_part1.tcl -notrace
