...
HD_PWD='C:/Users/Vetle/Desktop/Lab02_Vivado/Lab02_Part2_Full_adder/Lab02_Part2_Full_adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab02_part2_full_adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab02_part2_full_adder.tcl -notrace
